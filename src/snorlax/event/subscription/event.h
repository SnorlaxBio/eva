...
#define event_subscription_event_parameter_set(event, parameter)        ((event) ? ((event_subscription_event_t *) event)->func->parameter_set(event, ((int64_t)(parameter))) : (event_subscription_event_t *)((uint64_t)(parameter)))
