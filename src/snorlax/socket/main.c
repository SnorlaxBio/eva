...
int main(int argc, char ** argv) {
    ...
    server = socket_gen(socket_tcp_server_func_get(), AF_INET, SOCK_STREAM, IPPROTO_TCP, address_of(addr), sizeof(struct sockaddr_in));
    ...
    subscription = snorlax_eva_socket_sub((descriptor_t *) server, handler);
