...
struct descriptor_event_generator_func {
    ...
    int32_t (*on)(___notnull descriptor_event_generator_t *);
    int32_t (*off)(___notnull descriptor_event_generator_t *);
    int32_t (*pub)(___notnull descriptor_event_generator_t *, event_queue_t *);
    int32_t (*add)(___notnull descriptor_event_generator_t *, ___notnull descriptor_event_subscription_t *);
    int32_t (*del)(___notnull descriptor_event_generator_t *, ___notnull descriptor_event_subscription_t *);

    int32_t (*reg)(___notnull descriptor_event_generator_t *, ___notnull descriptor_event_subscription_t *);
};
...
#define descriptor_event_generator_reg(generator, subscription)     ((generator)->func->reg(generator, subscription))
